"""sunburst — two-level hierarchy radial click-drill with a depth cap.
...
def build(
    ...
    *,
    ...
    ids, labels, parents, values = _path_to_sunburst(df, path_cols, value_col, root_label)
    ...
    return theme.apply_theme(fig, "sunburst")
...
CHART = ChartSpec(
    ...
    build=build,
    sample=sample,
    interactions="radial click-drill, depth cap",
)
